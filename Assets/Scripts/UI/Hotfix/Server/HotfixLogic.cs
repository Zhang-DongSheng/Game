...
namespace Game.Logic
{
    public class HotfixLogic : Singleton<HotfixLogic>, ILogic
    {
        ...
        private IEnumerator Load()
        {
            ...
            #region DLL
            string url = string.Format("{0}/{1}.dll", Application.streamingAssetsPath, AssetPath.HotfixDll);
            ...
            #region PDB
            url = string.Format("{0}/{1}.pdb", Application.streamingAssetsPath, AssetPath.HotfixDll);
